...
public class MatchedProteinsBuilder {
	 ...
	 * @throws Exception
	 */
	public void buildMatchedProteins( LimelightInput limelightInputRoot, File fastaFile, Collection<MSFraggerReportedPeptide> reportedPeptides ) throws Exception {
	...
	private Collection<PeptideObject> getNakedPeptideObjectsForReportedPeptides( Collection<MSFraggerReportedPeptide> cometPeptides ) {

		Collection<PeptideObject> nakedPeptideObjects = new HashSet<>();

		for( MSFraggerReportedPeptide reportedPeptide : cometPeptides ) {
